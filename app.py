        ...
        if st.session_state.get('flight_started', False):
            ...
            if sim and sim.running:
                ...
                if new_hb:
                    ...
                    st.session_state.hb_list.insert(0, new_hb)          # 最新在前
...
def main():
    ...
    # ========================= 飞行监控页面 =========================
        ...
        st_autorefresh(interval=1000, key="monitor")   # 每秒刷新一次显示
        ...
        history = st.session_state.sim.history   # 从旧到新
        if len(history) >= 2:
